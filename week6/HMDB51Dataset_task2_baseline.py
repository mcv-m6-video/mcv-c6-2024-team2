...
class HMDB51Dataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            mode (str): The mode in which to create the dataset - basic, shuffle, same_frame.
        """
    ...
    def __getitem__(self, idx: int) -> tuple:
        ...
        if self.mode == 'basic' or self.mode == 'shuffle':
            ...
            frame_idx = random.randint(0, max(video_len - self.clip_length * self.temporal_stride, 0))
