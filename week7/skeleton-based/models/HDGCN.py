...
class EdgeConv(nn.Module):
    ...
    def get_graph_feature(self, x, k, idx=None):
        ...
        idx_base = torch.arange(0, N, device="cuda").view(-1, 1, 1) * V
...
class HDGCNModel(nn.Module):
    def __init__(self, num_class=51, num_point=17, num_person=1, graph=None, graph_args=dict(), in_channels=2,
                 drop_out=0, adaptive=True):
        super(HDGCNModel, self).__init__()
        ...
        self.l1 = TCN_GCN_unit(2, base_channels, A, residual=False, adaptive=adaptive, att=False, CoM=CoM)
